  ...
  return (
    <section id="how-it-works" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
      ...
      <div className="mt-20 relative">
        ...
        <div className="absolute top-1/2 left-12 right-12 hidden h-0.5 -translate-y-1/2 bg-neutral-100 dark:bg-neutral-800 lg:block" />
          ...
          {workflowSteps.map((step, idx) => {
            ...
            return (
              <div key={idx} className="relative flex flex-col items-center text-center">
                ...
                <p className="mt-2 text-[11px] leading-relaxed text-neutral-400 max-w-[160px]">
                  {step.description}
                </p>
              </div>
            );
